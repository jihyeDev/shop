...
<div style="height:100vh;">
	<ul class="nav flex-column font-weight-bold" style="position:fixed;">
		...
		<li class="nav-item">
			<a class="nav-link text-secondary pt-2 px-3" href="<%=request.getContextPath()%>/admin/selectOrderCommentList.jsp">상품평 관리</a>
		</li>
		<li class="nav-item">
			<a class="nav-link text-secondary pt-2 px-3" href="<%=request.getContextPath()%>/admin/selectNoticeList.jsp">공지게시판 관리</a>
		</li>
		<li class="nav-item">
			<a class="nav-link text-secondary pt-2 px-3" href="<%=request.getContextPath()%>/admin/selectQnaList.jsp">QnA게시판 관리</a>
		</li>
		<li>
