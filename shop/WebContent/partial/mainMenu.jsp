...
<nav class="navbar navbar-expand-sm navbar-light">
	<ul class="nav navbar-nav">
		...
		<li class="nav-item active"><a class="nav-link active" href="">menu1</a></li>
		<li class="nav-item active"><a class="nav-link active" href="">menu2</a></li>
		<li class="nav-item active"><a class="nav-link active" href="">menu3</a></li>
