...
<%@ page import="vo.*" %>
<%
	// deleteNotice.jsp 디버깅 구분선
	System.out.println("----------deleteNotice.jsp----------");
	...
	// 입력값 방어 코드
	// 삭제할 공지사항 번호(noticeNo)를 입력 받았는지 유효성 검사
	...
	// 특정 공지사항 게시글을 삭제시키는 noticeDao의 deleteNoticeByAdmin 메서드 호출
	if(noticeDao.deleteNoticeByAdmin(noticeNo)) {
