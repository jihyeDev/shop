...
<body>
<%
	// deleteEbookForm.jsp 디버깅 구분선
	System.out.println("----------deleteEbookForm.jsp----------");
	...
	// 입력값 방어 코드
	// 삭제할 전자책의 ebookNo을 입력 받았는지 유효성 검사
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-10 mt-5">
				<h3 class="font-weight-bold">전자책 관리 <small class="font-weight-light text-secondary">_ 삭제</small></h3>
				
				<form action="<%=request.getContextPath()%>/admin/deleteEbookAction.jsp" method="post">
					...
					<small class="text-danger">* 전자책의 정보를 확인한 뒤, 삭제해주세요 </small>
					<button type="submit" class="btn btn-outline-secondary center-block">삭제</button>
					<br>
				</form>
