...
<%@ page import = "dao.*" %>
<%
	// updateQnaAction.jsp 디버깅 구분선
	System.out.println("----------updateQnaAction.jsp----------");
	...
	// 입력값 방어 코드
	// Qna 게시글 입력값 유효성 검사
	if(request.getParameter("qnaTitle")==null || request.getParameter("qnaTitle").equals("") || request.getParameter("qnaCategory")==null || request.getParameter("qnaCategory").equals("") || request.getParameter("qnaContent")==null || request.getParameter("qnaContent").equals("") || request.getParameter("memberNo")==null || request.getParameter("memberNo").equals("") || request.getParameter("qnaNo")==null || request.getParameter("qnaNo").equals("")) {
	...
	// 방어코드
	// requst 매개값인 memberNo과 로그인 세션에 저장된 loginMember.getMemberNo()가 같아야 페이지 접속 가능
	...
	// Qna 게시글을 수정하는 qnaDao의 updateQnaByMember 메서드 호출
	if(qnaDao.updateQnaByMember(paramQna)) {
